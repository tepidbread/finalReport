...
\input{parts/20-areaCoverageModeling.tex}
...
\input{parts/appendix-implement} 	%
\input{parts/appendix-implement-code} % Code used in implementation

\input{parts/appendix-simulation}	%
\input{parts/appendix-simulation-code} % Code used in simulation

\input{parts/appendix-modelling}		% Matlab modelling etc...
